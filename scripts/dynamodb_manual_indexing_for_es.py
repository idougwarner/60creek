...
os.environ['AWS_PROFILE'] = "60creek"
...
def main():
  ...
  parser.add_argument('--rn', metavar='R', help='AWS region', default="us-west-2")
  parser.add_argument('--tn', metavar='T', help='table name', default="Prospect-fxcyw6gjnvgl5kkmcz4iewsuoa-stage")
  parser.add_argument('--lf', metavar='LF', help='lambda function that posts data to es', default="arn:aws:lambda:us-west-2:764739072793:function:DdbToEsFn-fxcyw6gjnvgl5kkmcz4iewsuoa-stage")
  parser.add_argument('--esarn', metavar='ESARN', help='event source ARN', default="arn:aws:dynamodb:us-west-2:764739072793:table/Prospect-fxcyw6gjnvgl5kkmcz4iewsuoa-stage/stream/2021-03-09T05:24:03.213")
