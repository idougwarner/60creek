        ...
        <div className="g-centered-form-with-header">
          <div className="g-form-container">
            ...
            <div className="g-input-box">
              ...
              />
              {userNameError ? (
                <div className="g-error-label smallest">
            ...
            <div
              className={
                "g-input-box" + (userNameError || loginError ? " error" : "")
              }
            >
              <div className="g-input-label">Password</div>
              <div
                className={
                  "eye-icon" + (showPassword ? " showing-password" : "")
                }
              ...
              />
              {loginError ? (
                <div className="g-error-label smallest">{loginError}</div>
              ) : null}
            </div>
            <Link className="g-link-item small" to="/password-reset">
              Forgot your Password?
            </Link>
            <Button
              disabled={!enbled || loading}
              className="w-100"
              onClick={(e) => {
                login();
              }}
